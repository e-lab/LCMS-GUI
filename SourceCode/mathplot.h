...
//     wxCoord y2p(double y, bool drawOutside = true); // { return (wxCoord) ( (m_posY-y) * m_scaleY); }
    ...
    */
    ...
    void ZoomOutX();
    /** Zoom in current view along Y and refresh display (modified for LCMS by JM)*/
    void ZoomInY_better( const wxPoint& centerPoint = wxDefaultPosition );
    /** Zoom out current view along Y and refresh display (modified for LCMS by JM)*/
    void ZoomOutY_better( const wxPoint& centerPoint = wxDefaultPosition );
